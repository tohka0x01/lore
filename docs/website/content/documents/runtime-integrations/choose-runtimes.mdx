...
| OpenCode *(prerelease `v1.3.15-pre.2`)* | you use OpenCode 1.18.3 or newer | native exact `lore_*` tools, Boot through `experimental.chat.system.transform`, and prompt Recall through `chat.message` |
