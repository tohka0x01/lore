...
The native OpenCode integration is a prerelease in `v1.3.15-pre.2`, tested with OpenCode 1.18.3. It reads the same `~/.lore/config.json` shown above and installs one managed file:
